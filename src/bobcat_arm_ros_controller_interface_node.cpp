...
int main(int argc, char **argv)
{
  ...
  supporter_pub_ = n.advertise<std_msgs::Float64>("/Bobby/supporter_position_controller/command", 100);
  loader_pub_ = n.advertise<std_msgs::Float64>("/Bobby/loader_position_controller/command", 100);
  brackets_pub_ = n.advertise<std_msgs::Float64>("/Bobby/brackets_position_controller/command", 100);
