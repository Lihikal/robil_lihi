...
class GazeboConnection():
    ...
    def __init__(self):
        ...
        self.clear_wrench = rospy.ServiceProxy('/gazebo/clear_joint_forces', JointRequest)
    ...
    def clearBodyWrenches(self):
        ...
        try:
            ...
            print("/gazebo/clear_body_wrenches service call failed")
    ...
    def resetJoint(self):
        ...
        try:
            ...
            print("/gazebo/clear_joint_forces service call failed")
